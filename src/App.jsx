 ...
 const projects = [
  ...
  <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto text-center relative z-10">
      ...
      Ingénieure en double diplôme <span className="text-purple-400 font-semibold">Mathématiques Appliquées</span> & <span className="text-pink-400 font-semibold">Data Science</span>, actuellement<span className="text-yellow-400 font-semibold"> à la recherche d’un PFE</span>.  
